...
experiment_directory_name = '10ary'
...
plt.plot(x,y_0,label='x=-9') # A bar chart
plt.plot(x,y_1,label='x=-7') # A bar chart
plt.plot(x,y_2,label='x=-5') # A bar chart
plt.plot(x,y_3,label='x=-3') # A bar chart
plt.plot(x,y_4,label='x=-1') # A bar chart
plt.plot(x,y_5,label='x=1') # A bar chart
plt.plot(x,y_6,label='x=3') # A bar chart
plt.plot(x,y_7,label='x=5') # A bar chart
plt.plot(x,y_8,label='x=7') # A bar chart
plt.plot(x,y_9,label='x=9') # A bar chart

#plt.title("pdf table made by picking points ")
plt.xlabel('y value')
plt.ylabel('pdf value')
plt.xticks([-11,-9,-7,-5,-3,-1,1,3,5,7,9,11])
